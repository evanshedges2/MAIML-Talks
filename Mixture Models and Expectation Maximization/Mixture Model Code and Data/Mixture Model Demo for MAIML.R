# Husky Mixture Model R Code for MAIML Presentation
# Evans Hedges

# Create husky dataset
...
# Compute expectation of a given datapoint
...
# Compute expectations for list of datapoints
...
# Given our expectations, return the new maximally likely pi parameter
...
# Given our expectations, return the new maximally likely mu1 parameter
...
# Given our expectations, return the new maximally likely mu2 parameter
...
# Given our expectations, return the new maximally likely sigma1 parameter
...
# Given our expectations, return the new maximally likely sigma2 parameter
...
while(TRUE){
  ...
  # Track new maximally likely model parameters
  ...
  # Stop if we have convergence within our pre-defined epsilon
  if(norm_diff < epsilon){
    break
  }
  
  # Halt at 100 iterations for the sake of my laptop
  if (counter > 100){
    break
  }
}
...
# Print mixture model parameters
print(pi)
print(muhat1)
print(sigmahat1)
print(muhat2)
...
# Failed attempt at gradient descent is below. 
